jQuery("#simulation")
  .on("click", ".s-e39b167a-6827-498b-8062-bf89d74c1e48 .click", function(event, data) {
          ...
          "blocks": [
            {
              "actions": [
                ...
                },
                {
                  ...
                  "parameter": {
                    "target": "screens/f6ca07d8-4b5a-41d9-9c1f-5ff5615b8c54",
                    "transition": {
                      "type": "slideleft",
                      "duration": 700
                    }
  ...
  .on("pageload", ".s-e39b167a-6827-498b-8062-bf89d74c1e48 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-e39b167a-6827-498b-8062-bf89d74c1e48")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("swipeleft", ".s-e39b167a-6827-498b-8062-bf89d74c1e48 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swiperight", ".s-e39b167a-6827-498b-8062-bf89d74c1e48 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
