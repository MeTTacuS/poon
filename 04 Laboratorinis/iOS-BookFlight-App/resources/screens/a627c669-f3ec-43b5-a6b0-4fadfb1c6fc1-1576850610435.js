jQuery("#simulation")
  .on("click", ".s-a627c669-f3ec-43b5-a6b0-4fadfb1c6fc1 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/a3a4cbd6-314e-40b4-9a75-67704e082c6e"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("swipeleft", ".s-a627c669-f3ec-43b5-a6b0-4fadfb1c6fc1 .swipeleft", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("swiperight", ".s-a627c669-f3ec-43b5-a6b0-4fadfb1c6fc1 .swiperight", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
